      ...
      <div className="min-h-screen bg-[#fafafa] px-5 py-10">
        <div className="max-w-sm mx-auto">
          ...
          <div className="flex gap-2">
            ...
            <Link href="/apps/football-games/club-history/archive" className="flex-1 py-3 bg-white border border-[#e5e5e5] rounded-lg text-sm font-bold text-center hover:border-[#ccc] transition-colors">
              📅 Archive
            </Link>
          </div>
        </div>
      ...
      <div className="flex-shrink-0 bg-white border-b border-[#e5e5e5] px-4 py-3">
        <div className="max-w-xl mx-auto flex items-center justify-between">
          <div className="flex flex-col items-start gap-0.5">
            ...
            <Link href="/apps/football-games/club-history/archive" className="text-[10px] font-mono text-[#bbb] hover:text-purple-400 transition-colors">📅 archive</Link>
          </div>
